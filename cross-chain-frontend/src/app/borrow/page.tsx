...
import { NFT_LENDHUB_ADDRESS, NFT_LENDHUB_ABI, ERC721_ABI, WMON_ADDRESS } from "@/components/lib/constants"
...
export default function BorrowPage() {
  ...
  const isOwner = address && nftOwner && nftOwnerSuccess && address === nftOwner
        ...
        <main className="flex-1 container py-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-6 text-center">
              <h1 className="text-2xl font-bold text-foreground">Borrow Against Your NFT</h1>
              <p className="text-muted-foreground mt-1 text-sm">List your NFT as collateral and get a loan in wMON</p>
            </div>
                  ...
                  {nftId && nftAddress && nftOwner !== undefined && (
                    <div className="pt-1">
                      <p className="text-xs text-foreground">
                        Owner:{" "}
                        <span className={isOwner ? "text-green-500" : "text-red-500"}>
                          {isOwner ? "You own this NFT" : "You don't own this NFT"}
                        </span>
                      </p>
                    </div>
                  )}
