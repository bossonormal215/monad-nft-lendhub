...
export function LoanDetails({
  ...
  if (!loan?.amount || !loan?.interest) return null;
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-[#F5F6FC]">
                {ethers.utils.formatEther(loan.amount)} {tokenSymbol}
              </span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[#98A1C0]">Interest</span>
              <span className="text-[#F5F6FC]">
                {ethers.utils.formatEther(loan.interest)} {tokenSymbol}
              </span>
            </div>
            <div className="flex justify-between text-sm font-medium">
              <span className="text-[#98A1C0]">Total to Repay</span>
              <span className="text-[#F5F6FC]">
                {ethers.utils.formatEther(totalAmount)} {tokenSymbol}
              </span>
            </div>
          </div>
