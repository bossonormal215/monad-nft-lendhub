...
//                   NFT LendHub is a peer-to-peer lending platform that allows you to use your NFTs as collateral for
//                   loans or earn interest by lending to others.
//                 </p>
//               </div>
//               <div className="flex flex-col gap-2 min-[400px]:flex-row">
//                 <Button className="bg-monad-500 hover:bg-monad-600" onClick={() => onGetStarted()}>
//                   Get Started
//                 </Button>
//                 <Button variant="outline" onClick={() => window.open("https://monad.xyz", "_blank")}>
//                   Learn About Monad
//                 </Button>
//               </div>
//             </div>
...
//                 <Image src="/hero-image.png" alt="NFT Lending" fill className="object-contain" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//                 Our platform makes it easy to get liquidity from your NFTs or earn interest by lending to others.
//               </p>
//             </div>
//           </div>
...
//           <div className="flex flex-col items-center justify-center space-y-4 text-center">
//             <div className="space-y-2">
//               <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Built on Monad</h2>
//               <p className="max-w-[900px] text-muted-foreground md:text-xl">
...
//                 <Image src="/monad-logo.png" alt="Monad Logo" width={200} height={80} className="object-contain" />
//               </div>
//             </div>
//           </div>
//         </div>
